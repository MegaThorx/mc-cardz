export default function () {
    return <>
        ...
        <ul className="mt-3 ms-3 list-unstyled">
            <li><b>» Customizable Topics</b> → Users can create & modify their topics</li>
            <li><b>» AI-Generated Answer Options</b> → Automatically generates (false) answers for every question</li>
            <li><b>» Quiz-Mode</b> → Practice questions in quiz mode</li>
        </ul>
        <hr/>
        <p></p>
    </>;
